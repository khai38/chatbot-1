...
import { PlusIcon, BookIcon, TrashIcon, UploadIcon, FileTextIcon, ImageIcon, TableIcon, ArrowPathIcon, CheckIcon, ArrowUturnLeftIcon } from './Icons';
...
const SourcePanel: React.FC<SourcePanelProps> = ({ sources, onAddSource, onDeleteSource, onStartNewChat, onSaveChanges, onCancelChanges, hasUnsavedChanges }) => {
  ...
  return (
    <div className="bg-gray-100 flex flex-col h-full">
      ...
      {hasUnsavedChanges && (
        <div className="p-3 mx-4 mb-2 border border-amber-300 bg-amber-100 rounded-lg shadow-inner">
            <p className="text-sm font-semibold text-amber-800 mb-2 text-center">Bạn có thay đổi chưa được lưu.</p>
            <div className="flex gap-3 justify-center">
                <button
                    onClick={onCancelChanges}
                    className="flex items-center gap-2 px-5 py-2 neumorph-raised neumorph-button text-sm font-medium text-slate-800"
                >
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700"
